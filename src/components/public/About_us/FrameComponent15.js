...
const FrameComponent15 = ({ className = "" }) => {
  ...
  const contentData = {
    mainTitle: "Engage Effortlessly with Stammer",
    card1: {
      title: "Instant Responses",
      description:
        "Answer customer queries instantly and efficiently with our specialized chatbot.",
    },
    card2: {
      title: "Seamless Integration",
      description:
        "Easily integrate Stammer into your workflow for enhanced customer engagement.",
    },
  };
