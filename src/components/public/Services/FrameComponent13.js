...
const FrameComponent13 = ({ className = "" }) => {
  ...
  const contentData = {
    contentData1: {
      heading: "Elevate Your Sales",
      description:
        "Engage new customers and customize your sales strategies with Stammer",
    },
    contentData2: {
      heading: "Boost Customer Interaction",
      description:
        "Interact with your clients and develop strong relationships effortlessly",
    },
    contentData3: {
      heading: "Maximize Opportunities",
      description:
        "Uncover new potential and expand your market reach proficiently",
    },
  };
