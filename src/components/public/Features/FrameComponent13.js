...
const FrameComponent13 = ({ className = "" }) => {
  ...
  const contentData = {
    contentData1: {
      heading: "Smart Interactions",
      description:
        "Enhance customer engagement by providing accurate answers instantly with Stammer.",
    },
    contentData2: {
      heading: "Seamless Integrations",
      description:
        "Easily connect with BestBuy inventory and data to offer tailored customer service.",
    },
    contentData3: {
      heading: "Boost Sales",
      description:
        "Unlock new possibilities and drive growth by utilizing our robust chatbot solution.",
    },
  };
