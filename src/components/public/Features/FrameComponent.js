...
const FrameComponent = ({ className = "" }) => {
  ...
  const contentData = {
    ...
    frameComponents: [
      {
        header: "CHATBOT INTERACTION",
        description:
          "Engage customers efficiently with our smart chatbot, customized with BestBuy's inventory.",
      },
      {
        header: "INVENTORY INSIGHTS",
        description:
          "Quickly access detailed data on BestBuy's products with our user-friendly dashboard.",
      },
      {
        header: "SEAMLESS INTEGRATION",
        description:
          "Effortlessly integrate Stammer with BestBuy's system for smooth operation.",
      },
      {
        header: "LIVE DEMO",
        description:
          "Test our chatbot instantly with a simple click and see its capabilities in action.",
      },
    ],
  };
